...
menu:
  spice_geral:
    name: Instalando o Electric
    parent: Tutoriais de Instalação
    weight: 2003
title: Instalando o Electric
toc: true
type: docs
weight: 2003
output:
...
O Electric possui duas janelas ativas, uma em que as biliotecas e circuitos são editados e manipulados e uma outra de mensagens com resultados dos comandos que foram ou estão sendo executados. A janela de mensagens é especialmente importante para acompanhar erros durante a edição de circuitos.
...
Na página do Electric há a seção de documentação com o [manual](https://www.staticfreesoft.com/documentsUser.html) _online_, que pode ser [baixado em PDF também](https://www.staticfreesoft.com/jmanual/ElectricManual-9.07.pdf), e a $2^{a}$ edição do livro [**_Computer Aids for VLSI Design_**](https://www.rulabinsky.com/cavd/) que foi escrito por **Steven M. Rubin**, o desenvolvedor original do Electric.
